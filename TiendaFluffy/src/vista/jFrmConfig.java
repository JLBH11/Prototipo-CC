...
public jFrmConfig(Tienda tienda, Usuario usuario) {
    initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Cambiar Informacion De Usuario");
    ...
    // Guardar usuarios en disco si es necesario
    tienda.guardarUsuarios();
